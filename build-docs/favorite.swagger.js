...
exports.getFavoriteList = exports.deleteProductFromFavorite = exports.checkProductInFavoriteList = exports.addFavoriteProduct = void 0;
const addFavoriteProduct = {
  tags: ['Favorite'],
  description: 'This route allow logged in user/seller/admin to add product to his favorite list',
...
const getFavoriteList = {
  tags: ['Favorite'],
  description: 'This route allow logged in user/seller/admin to get his favorite products list',
...
const deleteProductFromFavorite = {
  tags: ['Favorite'],
  description: 'This route allow logged in user/seller/admin to delete product from favorite list',
...
exports.deleteProductFromFavorite = deleteProductFromFavorite;
const checkProductInFavoriteList = {
  tags: ['Favorite'],
  description: 'This route allow logged in user/seller/admin to check if product in favorite list',
...
exports.checkProductInFavoriteList = checkProductInFavoriteList;