...
export const messages = {
  en: {
    ...
    successfullCreated: 'Success fully Created',
    successfulFound: 'Success fully Found',
    successfulDeleted: 'Success Full Deleted',
    successfulUpdated: 'Success Full Updated',
    successful: 'Success',
    noItemInCart: 'No Item In the cart with this id',
    ImageRequired: 'Image Required',
    videoRequired: 'Ads Video Required',
    notExists: 'Not Exist in System'
  },
  ar: {
    ...
    successfullCreated: 'تم إنشاؤه بنجاح',
    successfulGetDiscount: 'تم العثور علي الخصم بنجاح.',
    successfulDeleted: 'تم حذف النجاح بالكامل',
    successfulUpdated: 'نجاح كامل محدث',
    successfulFound: 'وجدت النجاح بالكامل',
    successful: 'نجاح',
    noItemInCart: 'لا يوجد عنصر في سلة التسوق مع هذا المعرف',
    ImageRequired: 'الصورة مطلوبة',
    videoRequired: 'مطلوب فيديو',
    notExists: 'غير موجود في النظام'
  }
};
