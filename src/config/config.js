...
const envVarsSchema = Joi.object()
  .keys({
    ...
    APP_URL: Joi.string().description('Application Url'),
    ...
    EMAIL_FROM: Joi.string().description('SMTP Email'),
    SMTP_PASSWORD: Joi.string().description('SMTP Passwors'),
